...
export default function StaggeredCheckbox() {
                ...
                <div ref={ref} className="mt-4">
                    {items.map((item) => (
                        ...
                        <input
                            ...
                            type="checkbox"
                            className="mr-4 h-4 w-4 rounded-sm border-2 border-gray-300 text-indigo-600 transition-colors duration-300 focus:ring-0 focus:ring-offset-0 focus-visible:ring-2 focus-visible:ring-indigo-600/50 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-100 group-active:border-indigo-600 group-active:checked:text-indigo-600/25"
                        />
                        {item.text}
                        </label>
                    ))}
