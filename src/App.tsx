                ...
                <figure className="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
                    <div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
                        <blockquote className="text-xl font-semibold leading-8 text-gray-700 sm:text-2xl sm:leading-9">
                            <p>
                                <span className="text-sky-500">Framer Motion</span> provides a declarative and easy-to-use way to create fluid and interactive animations for web applications
                    ...
                    <div className="col-end-1 w-16 lg:row-span-4 lg:w-72">
                        ...
                        src="https://a-us.storyblok.com/f/1014535/1024x1024/91e6236b80/framer-motion-hero.png"
                        alt=""
                        />
                    </div>
